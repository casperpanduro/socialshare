...
<div class="social-share">
    <ul>
        ...
        <li><a href="https://plus.google.com/share?url=YOUR_URL_HERE<?php the_permalink();?>" class="googleplus" target="_blank" title="Del på Google plus"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
